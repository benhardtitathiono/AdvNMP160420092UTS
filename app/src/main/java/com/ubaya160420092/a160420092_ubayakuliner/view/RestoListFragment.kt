...
import com.ubaya160420092.a160420092_ubayakuliner.viewmodel.RestoListViewModel
import androidx.lifecycle.Observer

/**
 * A simple [Fragment] subclass.
 * Use the [RestoListFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RestoListFragment : Fragment() {

    private lateinit var viewModel: RestoListViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(RestoListViewModel::class.java)
        viewModel.refresh()
